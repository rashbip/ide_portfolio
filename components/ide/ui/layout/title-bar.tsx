...
export function TitleBar({ files, openFile, onCreateFile, onSave, onSaveAs, onOpenFile, onToggleSidebar, onToggleTerminal, onExit, onRun, onDebug, activeFile, allFiles, isWindowed, onMinimize, onMaximize, onClose }: Props) {
    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-0.5">
          ...
          <button onClick={onMaximize} className="p-1.5 rounded hover:bg-white/10 transition-colors" title="Maximize" aria-label="Maximize">
            <Square className="w-3 h-3 text-muted-foreground" />
          </button>
          <button onClick={onClose} className="p-1.5 rounded hover:bg-red-500/80 transition-colors group" title="Close" aria-label="Close">
